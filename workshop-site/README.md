...
Includes a **Quickstart scripts** section with `npm run demo:up` / teardown aliases. Live feature-flag controls are disabled on GitHub Pages (`DEMO_CONTROLS_ENABLED = false` in `app.js`).
